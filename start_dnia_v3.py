...
try:
    ...
    for slownik in zadania_do_uruchomienia:
        ...
        session.findById("wnd[0]/tbar[0]/okcd").text = slownik['transakcja']  # w ten sposób pobieramy wartość przypisaną do klucza 'transakcja'
        ...
        if slownik['wariant']:
            ...
            session.findById("wnd[1]/usr/txtV-LOW").text = slownik['wariant']  # podajemy nazwę wariantu
        ...
        if numer_sesji < len(zadania_do_uruchomienia) - 1:
            ...
            numer_sesji += 1  # zwiększamy numer sesji o 1 po każdej iteracji pętli
